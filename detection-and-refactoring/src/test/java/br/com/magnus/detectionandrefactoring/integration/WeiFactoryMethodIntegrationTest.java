...
/**
 * Integration test for Wei Factory Method pattern detection and refactoring.
...
class WeiFactoryMethodIntegrationTest extends BaseIntegrationTest {
    ...
    void testFactoryMethodPatternRefactoring() throws IOException {
        ...
        assertThat(refactoredContent).containsKey("factory/Logger.java");
        assertThat(refactoredContent).containsKey("factory/LoggerFactory.java");
        assertThat(refactoredContent).containsKeys(
                "factory/DataBaseLoggerFactory.java",
                "factory/FileLoggerFactory.java"
        );

        // Verify LoggerFactory is now abstract
