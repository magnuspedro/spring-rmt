...
class MetricsConsumerTest {
    ...
    @BeforeEach
    public void setup() {
        metricsConsumer = new MetricsConsumer(extractProjects, processor, projectRepository);
    }
    ...
    public void shouldTestForAProjectNotFound() {
        ...
        assertThrows(IllegalArgumentException.class, () -> metricsConsumer.listener("id"));
